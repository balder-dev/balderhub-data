...
This is a BalderHub project that is used by different other packages and provides support for managing data.

.. note::
   Please note, this package is still under development. If you would like to contribute, take a look into the
   `project <https://github.com/balder-dev/balderhub-data/>`_.
