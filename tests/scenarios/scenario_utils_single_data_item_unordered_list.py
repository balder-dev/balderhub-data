...
class ScenarioUtilsSingleDataItemUnsortedList(ScenarioUnit):
    ...
    def test_get_element_type_for(self):
        assert NestedSingleRef.is_optional_field('unsorted_list') is False
        ...
        assert NestedSingleRef.is_optional_field('unsorted_list_of_single_data_items') is False
        assert NestedSingleRef.get_field_data_type('unsorted_list_of_single_data_items') == UnorderedList
        assert NestedSingleRef.get_element_type_for_list('unsorted_list_of_single_data_items') == SimpleDataItem

        assert NestedSingleRef.is_optional_field('optional_list_of_single_data_items') is True
        assert NestedSingleRef.get_field_data_type('optional_list_of_single_data_items') == UnorderedList
        assert NestedSingleRef.get_element_type_for_list('optional_list_of_single_data_items') == SimpleDataItem